...
if ( isset($_GET[id]) && !empty($_GET[id]) ) {
	...
	for ($i=0; $i < $how_pages-1; $i++) { 
		$myrow_1 = mysqli_fetch_array($result_1, MYSQLI_ASSOC);
		if ( !empty($myrow_1[genre_name]) ) {
			echo "<a href=\"/genre.php/?id=$myrow_1[genre_id]\">$myrow_1[genre_name]</a>";
		echo '<a title="удалить" style="color:red" class="del_a" href="/admin/inc/del_genre.php/?id='. $myrow_1[genre_id].'">х</a><br>';
		}
	}
}
echo "</section>";
